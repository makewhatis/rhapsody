...
mod tests {
    ...
    impl rhapsody_store::Store for UnreadableEvents {
        ...
        fn save_manager_wake(
            &self,
            row: rhapsody_store::ManagerWakeRow,
        ) -> Result<(), rhapsody_store::StoreError> {
        ...
        fn manager_wake(
            &self,
            id: &str,
        ) -> Result<Option<rhapsody_store::ManagerWakeRow>, rhapsody_store::StoreError> {
            self.0.manager_wake(id)
        }

        fn load_manager_wakes(
            &self,
        ) -> Result<Vec<rhapsody_store::ManagerWakeRow>, rhapsody_store::StoreError> {
        ...
        fn manager_wake_unspent_for_issue(
            &self,
            issue_id: &str,
        ...
        ) -> Result<rhapsody_store::ManagerActivationOutcome, rhapsody_store::StoreError> {
        ...
        fn manager_intervention(
            &self,
            id: &str,
        ) -> Result<Option<rhapsody_store::ManagerInterventionRow>, rhapsody_store::StoreError>
        {
        ...
        fn load_manager_interventions(
            &self,
        ) -> Result<Vec<rhapsody_store::ManagerInterventionRow>, rhapsody_store::StoreError>
        {
        ...
        ) -> Result<rhapsody_store::ManagerReservation, rhapsody_store::StoreError> {
        ...
        fn manager_budget(
            &self,
            pr: &str,
        ) -> Result<Option<rhapsody_store::ManagerBudgetRow>, rhapsody_store::StoreError> {
        ...
        fn save_manager_exchange(
            &self,
            a0: rhapsody_store::ManagerExchange,
        ) -> Result<(), rhapsody_store::StoreError> {
            self.0.save_manager_exchange(a0)
        }
        fn manager_exchanges(
            &self,
            a0: &str,
        ) -> Result<Vec<rhapsody_store::ManagerExchange>, rhapsody_store::StoreError> {
            self.0.manager_exchanges(a0)
        }
        fn set_manager_exchange_state(
            &self,
            a0: &str,
            a1: &str,
        ) -> Result<(), rhapsody_store::StoreError> {
            self.0.set_manager_exchange_state(a0, a1)
        }
