...
// Toggle — emerald switch with a sliding knob. Ported from `ui.jsx`; `role="switch"` +
// `aria-checked` make the on/off state assistive-tech and test friendly.
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: 999,
        border: "1px solid",
        borderColor: checked ? "var(--em-dim)" : "var(--line-strong)",
        background: checked ? "var(--em)" : "rgba(255,255,255,.06)",
        position: "relative",
